...
@section('header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('buku.create') }}" style="color: white; text-decoration: none;">
                    ...
                    <tbody>
                        ...
                        @foreach ($buku as $item)
                            <tr>
                                ...
                                <td>{{ $item->stok }}</td>
                                <td>
                                @if ($item->penerbit_id === 1)
                                    Penerbit Informatika
                                @elseif ($item->penerbit_id === 2)
                                    Andi Offset
                                @else
                                    Danendra
                                @endif
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('buku.edit', $item->id) }}" class="btn btn-warning btn-circle">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a href="{{ route('buku.destroy', $item->id) }}" class="btn btn-danger btn-circle">
